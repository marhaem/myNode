...
(function(process) {
  ...
  exports = module.exports = internals.Connection = function(server, options) {
    ...
    this.server = server;
    this.settings.labels = Hoek.unique(this.settings.labels || []);
  ...
  internals.Connection.prototype.inject = function(options, callback) {
    ...
    if (!settings.authority || settings.credentials || settings.app || settings.plugins || settings.allowInternals !== undefined) {
      settings = Hoek.shallow(settings);
