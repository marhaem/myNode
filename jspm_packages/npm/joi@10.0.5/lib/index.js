...
internals.root = function() {
  ...
  root.extend = function() {
    ...
    for (let i = 0; i < extensions.length; ++i) {
      ...
      const base = (extension.base || this.any()).clone();
      ...
      const type = class extends ctor {
        constructor() {
          ...
          if (extension.language) {
            ...
            this._settings.language = Hoek.applyToDefaults(this._settings.language, {[extension.name]: extension.language});
          }
        }
      };
      if (extension.coerce) {
  ...
  root.version = require('../package.json!systemjs-json').version;
  return root;
};
